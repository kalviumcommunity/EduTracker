...
export default function Sidebar({ navigate, currentPage }) {
  ...
  const isActive = (item) => {
    ...
    if (item.page === 'courses' && (currentPage === 'courses' || currentPage === 'course-detail' || currentPage === 'learning')) return true
    return false
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <span style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: 16, color: '#111827', display: 'block', lineHeight: 1.1 }}>
            EduTrack
          </span>
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 10, fontWeight: 700, color: role === 'admin' ? '#7C3AED' : '#2563EB', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            {role === 'admin' ? 'Admin Suite' : 'Learning Hub'}
          </span>
        </div>
      </div>

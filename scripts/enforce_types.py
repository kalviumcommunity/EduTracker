...
def convert_currency_to_float(df, currency_columns):
    ...
    for col in currency_columns:
        ...
        try:
            ...
            failed_conversions = int(df_typed[col].isnull().sum() - df[col].isnull().sum())
...
def compare_dtypes(df_original, df_typed):
    ...
    output_path = 'output/dtype_conversion_report.csv'
...
if __name__ == "__main__":
    ...
    filepath = 'data/raw/untyped_data.csv'
    ...
    # Determine output path robustly
    output_path = 'data/processed/typed_data.csv'
    ...
    print(f"\n✓ Typed data saved to {output_path}")
